            ...
            <div className="flex flex-col space-y-2">
                ...
                }
                {
                    ["Login with Google 🔎", "Login with Facebook 📘"].map((buttonText) => {
                        return (
                            <button key={buttonText} type="button" className="border-2 border-gray-400 rounded-md px-2 py-1 focus:ring-1 focus:ring-blue-500 focus:outline-none" >{buttonText}</button>
                        )
                    })
                }
            </div>
